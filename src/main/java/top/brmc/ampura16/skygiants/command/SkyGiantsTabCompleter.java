...
public class SkyGiantsTabCompleter implements TabCompleter {
    ...
    public List<String> onTabComplete(CommandSender sender, Command cmd, String alias, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if ("add".equals(teamSubCommand) || "remove".equals(teamSubCommand) || "setspawn".equals(teamSubCommand)) {
                // team add, remove 或 setspawn 命令的第三个参数补全 (房间名称)
                List<String> gameNames = gameManager.getAllGameNames();
            ...
            if ("add".equals(teamSubCommand)) {
                ...
                // team remove 或 setspawn 命令的第四个参数补全 (队伍名称)
